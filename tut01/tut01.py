...
velocity["U'=U - U avg"]=' '
velocity.loc["U'=U - U avg"]= -velocity['U Avg'][0]+velocity['U']
velocity["V'=V - V avg"]=' '
velocity.loc["V'=V - V avg"]= -velocity['V Avg'][0]+velocity['V']
velocity["W'=W - W avg"]=' '
velocity.loc["W'=W - W avg"]= -velocity['W Avg'][0]+velocity['W']
velocity['OCTANT']=' '

# Filling of the rows for all values 
for i in range(velocity['Time'].size):
  if(velocity.loc["U'=U - U avg"][i]>0 and int(velocity.loc["V'=V - V avg"][i])>0):velocity.loc['OCTANT'][i]=1
  if(velocity.loc["U'=U - U avg"][i]<0 and velocity.loc["V'=V - V avg"][i]>0):velocity.loc['OCTANT'][i]=2
  if(velocity.loc["U'=U - U avg"][i]<0 and velocity.loc["V'=V - V avg"][i]<0):velocity.loc['OCTANT'][i]=3
  if(velocity.loc["U'=U - U avg"][i]>0 and velocity.loc["V'=V - V avg"][i]<0):velocity.loc['OCTANT'][i]=4
  if(velocity.loc["W'=W - W avg"][i]<0):velocity.loc['OCTANT'][i]*=-1
...
velocity['2'][Last+1]="Overall Transition Count"
